  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker' ></fieldset>"),
          $year = $("<select class='birth-year' name='birth[year]' style='margin: 3px!important;'></select>"),
          $month = $("<select class='birth-month' name='birth[month]' style='margin: 3px!important;'></select>"),
          $day = $("<select class='birth-day' name='birth[day]' style='margin: 3px!important;'></select>");
      ...
      for (var i=startYear; i>=endYear; i--) { $("<option style='padding:3px;'></option>").attr("value", i).text(i).appendTo($year); }
      for (var j=0; j<12; j++) { $("<option style='padding:3px;'></option>").attr("value", j+1).text(months[settings["monthFormat"]][j]).appendTo($month); }
      for (var k=1; k<32; k++) { $("<option style='padding:3px;'></option>").attr("value", k).text(k).appendTo($day); }
      ...
      // Update the option sets according to options and users selections
