...
//	});
	...
	// datepicker
	$(".datepicker-input").each(function(){ $(this).datepicker({format : 'dd-mm-yyyy'});});
...
//    setTimeout(function(){addMsg($msg);}, 1500);
	...
	$('[data-ride="datatables"]').each(function() {
		var oTable = $(this).dataTable({ "aaSorting": [],"iDisplayLength": 50,"sPaginationType": "full_numbers"} );
	});
//      "bServerSide": true,
...
//          "sServerMethod": "POST"
	  ...
	  //Select Multi Tag is required?
	// select2
 	//if ($.fn.select2) {
     // $("#select2-option").select2();
     // $("#select2-tags").select2({
     //   tags:["admin", "basic", "Manager"],
     //   tokenSeparators: [",", " "]}
     // );
  	//}
